...
core_prefix=${CYY}${CMM}${CDD}.${CHH}0000.fv_core.res
...
vars_append=cld_amt,graupel,ice_wat,liq_wat,o3mr,rainwat,snowwat,sphum
...
if [ $NMEM_AERO -gt 0 ]; then
  for mem0 in {${ENSBEG}..${ENSEND}}; do
	...
	mem_tracer2=${memdir}/${core_prefix}.tile${itile}.nc_tmp
