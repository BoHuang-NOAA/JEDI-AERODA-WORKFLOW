...
#export CDUMP=gfs
export CDUMP=gdas
export CASE_HIGH=C96
export CASE_ENKF=C96
export CDATE=2018050900
...
if [ $machine = WCOSS_C ]; then
 ...
 #export HOMEgfs=/scratch1/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/expCodes/GSDChem_cycling/global-workflow/
 export HOMEgfs=/scratch1/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/expCodes/GSDChem_cycling/global-workflow-clean/
 #export PTMP=${PTMP:-"/scratch2/NCEPDEV/stmp1/$USER"}
 export PTMP=/scratch1/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/expCodes/GSDChem_cycling/global-workflow-clean/getGFSIC/1stCycleBckg-${CDATE}/
 mkdir -p ${PTMP}
