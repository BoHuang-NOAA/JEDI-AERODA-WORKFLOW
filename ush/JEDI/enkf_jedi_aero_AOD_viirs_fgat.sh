...
source $JEDIUSH/enkf_nml_AOD_viirs_fgat.sh
...
while [[ $itile -le 5 ]]; do
    ...
    ${NLN} ${ROTDIR}/enkfgdas.${PDY}/${cyc}/${charnanal}/obs//aod_viirs_hofx_nomodel_${PDY}${cyc}_000${itile}.nc4.ges ${analdir}/aod_viirs_hofx_000${itile}.nc4
    ((itile=itile+1))
done
